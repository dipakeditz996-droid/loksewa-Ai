...
if __name__ == '__main__':
    print("==================================================")
    print(" LOKSEWAAI PERFORMANCE ENGINEERING - POST-OPTIMIZATION AUDIT")
    print("==================================================")
    ...
    # Warm up connection so we measure steady-state production performance with CONN_MAX_AGE
    ...
    print("Saved post-optimization results to after_results.json")
