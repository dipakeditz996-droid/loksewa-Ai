...
export default function AdminNotificationsOverviewPage() {
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h2 className="text-xl font-bold text-[#0B2545] hidden sm:block">Notifications</h2>
      </div>
      <div className="bg-white border border-slate-200 rounded-xl p-8 flex flex-col items-center justify-center text-center min-h-[400px]">
        ...
        <p className="text-slate-500 max-w-md mb-6">
          The backend API does not currently support creating, broadcasting, or managing notifications from the admin dashboard. This module is marked as a backend gap and will be implemented in a future release.
        </p>
