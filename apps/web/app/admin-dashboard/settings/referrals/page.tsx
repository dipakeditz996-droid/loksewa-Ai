    ...
    return (
      <div className="max-w-4xl space-y-6">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Configure XP rewards, level thresholds, and referral conditions.</p>
        </div>
    ...
    <div className="max-w-4xl space-y-8 pb-12">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          ...
          <Button className="bg-[#0B2545] dark:bg-slate-800 hover:bg-[#0B2545]/90" onClick={handleSave} disabled={saving}>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 dark:bg-slate-950 flex justify-between items-center">
          ...
          <label className="flex items-center cursor-pointer">
            <div className="relative">
              ...
              <div className={`dot absolute left-1 top-1 bg-white dark:bg-slate-900 w-6 h-6 rounded-full transition-transform ${settings.is_enabled ? 'transform translate-x-6' : ''}`}></div>
            </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 dark:bg-slate-950">
          <h2 className="text-lg font-semibold text-slate-800">Reward Amounts</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400">Configure what students earn for successful referrals.</p>
        </div>
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">

          <div className="space-y-6">
            <h3 className="font-semibold text-slate-700 dark:text-slate-300 border-b pb-2">Referrer (Student who invites)</h3>
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-12 py-2 border border-slate-300 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-[#0B2545] outline-none"
                />
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Coins Reward</label>
              <div className="relative">
                <input
                  type="number"
                  value={settings.referrer_coins_reward}
                  onChange={(e) => handleChange('referrer_coins_reward', parseInt(e.target.value) || 0)}
                  className="w-full pl-4 pr-16 py-2 border border-slate-300 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-[#0B2545] outline-none"
                />
          ...
          <div className="space-y-6">
            <h3 className="font-semibold text-slate-700 dark:text-slate-300 border-b pb-2">Referred Student (New User)</h3>
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">XP Reward</label>
              <div className="relative">
                <input
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 dark:bg-slate-950">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Define what action the new user must take to unlock the reward.</p>
        </div>
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">

          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Required Action</label>
            <select
              value={settings.qualification_action}
              onChange={(e) => handleChange('qualification_action', e.target.value)}
              className="w-full p-3 border border-slate-300 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-[#0B2545] outline-none bg-white dark:bg-slate-900"
            >
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Reward Processing</label>
            <select
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 dark:bg-slate-950">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Configure how XP translates into Student Levels.</p>
        </div>
        <div className="p-6">
          <div className="max-w-md">
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">XP Required Per Level (Fixed)</label>
            <div className="relative">
              <input
                type="number"
