...
export default function StudyPlanDetailsPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto flex flex-col items-center justify-center min-h-[60vh]">
      ...
      <h2 className="text-2xl font-bold text-slate-700">Study Plan API Pending</h2>
      ...
      <Button className="mt-6" variant="outline" onClick={() => router.push("/admin-dashboard/study-plans")}>
        <ArrowLeft className="w-4 h-4 mr-2" /> Back to Study Plans
      </Button>
    </div>
  );
}
