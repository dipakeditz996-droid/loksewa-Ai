...
import {
  Calendar, Search, MoreVertical, Eye,
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#0B2545] flex items-center gap-2">
            ...
            Assigned Study Plans
          </h1>
          <p className="text-slate-500 text-sm mt-1">Study plan records created by admins and assigned to students.</p>
        </div>
      </div>

      {/* Total comes from the server; per-page counts are never presented as totals */}
      <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm max-w-xs">
        <p className="text-slate-600 text-sm font-medium mb-1">Assigned plans (matching filters)</p>
