  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pb-1">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-primary dark:text-foreground tracking-tight">Examination Results</h2>
          <p className="text-sm text-muted-foreground mt-0.5">
            View your finalized and published examination results, answer sheets, and score breakdowns.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {loading ? (
          ...
          <div className="col-span-full py-16 text-center border-2 border-dashed border-border rounded-xl bg-muted/40">
