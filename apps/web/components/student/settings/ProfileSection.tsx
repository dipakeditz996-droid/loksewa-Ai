...
import { studentSettingsApi, StudentProfile } from "@/lib/api/student-settings";
...
export function ProfileSection() {
  ...
  const [form, setForm] = useState({
    ...
    phone: "",
    bio: "",
    target_category: null as number | null,
    target_position: null as number | null,
  });
  ...
  const updateMutation = useMutation({
    mutationFn: (data: Partial<StudentProfile>) => studentSettingsApi.updateProfile(data),
    onSuccess: () => {
  ...
  const removePhotoMutation = useMutation({
    mutationFn: () => studentSettingsApi.removePhoto(),
    onSuccess: () => {
