    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-2xl border border-border/80 shadow-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-primary dark:text-foreground">Change Password</h3>
        ...
        <div className="max-w-md space-y-5">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Input
                ...
                className="pr-10 bg-muted/50 border-border focus:border-[#D4A72C] focus:ring-[#D4A72C]/20"
              />
              <button
                type="button"
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Input
                ...
                className={cn(
                  "pr-10 bg-muted/50 border-border focus:border-[#D4A72C] focus:ring-[#D4A72C]/20",
          ...
          <Button
            ...
            disabled={!canSubmit}
            className="bg-primary text-primary-foreground hover:bg-[#163E6B] text-white w-full"
          >
            {mutation.isPending ? (
      ...
      {/* Active Sessions */}
      <div className="bg-card rounded-2xl border border-border/80 shadow-sm p-8">
        <h3 className="text-lg font-semibold text-primary dark:text-foreground mb-2">Active Sessions</h3>
        <p className="text-xs text-muted-foreground mb-6">Manage where you're signed in.</p>

        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-950/30/50 border border-green-200 dark:border-green-900/50/50 rounded-xl">
            <div className="flex items-center gap-3">
              <Monitor className="h-5 w-5 text-green-600" />
              <div>
                <p className="text-sm font-medium text-primary dark:text-foreground">Current Session</p>
