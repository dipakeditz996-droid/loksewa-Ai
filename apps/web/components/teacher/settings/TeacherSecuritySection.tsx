...
import { changeTeacherPassword } from "@/lib/api/teacher-settings";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Shield, Loader2, Eye, EyeOff, Monitor } from "lucide-react";
...
export function TeacherSecuritySection() {
  ...
  const mutation = useMutation({
    mutationFn: () => changeTeacherPassword(form),
    onSuccess: () => {
