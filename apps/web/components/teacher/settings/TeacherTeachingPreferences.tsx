    ...
    <div className="space-y-6">
      <Card className="bg-card border-border shadow-sm rounded-2xl overflow-hidden">
        <CardHeader className="bg-muted/50 border-b border-border">
          <CardTitle className="text-lg font-bold text-foreground">Teaching Preferences</CardTitle>
          <CardDescription>Default settings for when you create questions and materials.</CardDescription>
        </CardHeader>
        <CardContent className="p-8">
          <div className="max-w-md space-y-6">
            <div className="space-y-3">
              <Label className="text-[13px] font-semibold text-foreground">Preferred Question Difficulty</Label>
              <Select 
                value={form.preferred_difficulty} 
                onValueChange={(val) => { setForm({ ...form, preferred_difficulty: val }); setDirty(true); }}
              >
                <SelectTrigger className="w-full bg-background border-border text-foreground focus:border-primary focus:ring-primary/20 rounded-xl h-11">
              ...
              <p className="text-xs text-muted-foreground">Sets the default difficulty when adding new questions to the Question Bank.</p>
            </div>

            <div className="space-y-3">
              <Label className="text-[13px] font-semibold text-foreground">Preferred Question Type</Label>
              <Select 
              ...
              <p className="text-xs text-muted-foreground">Sets the default type when adding new questions to the Question Bank.</p>
            </div>
